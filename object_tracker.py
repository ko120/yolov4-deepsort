...
def main(_argv):
    ...
    frame_num = 0
    # Variables used for tracking centroid
    ...
    while True:
        ...
        # if enable info flag then print details about each track
            if FLAGS.info:
              ...
              if FLAGS.xaxis:
                print("Time: {} Tracker ID: {}, Class: {}, left: {}, right: {} ".format(current_time[:19], str(track.track_id), class_name, left, right))
              elif FLAGS.yaxis:
                print("Time: {} Tracker ID: {}, Class: {}, donw: {}, up: {} ".format(current_time[:19], str(track.track_id), class_name, down, up))
        ...
        if FLAGS.count:
          if FLAGS.xaxis:
            cv2.putText(frame, f'Left: {left} Right: {right}', (5, 155), font, 3, (0, 0xFF, 0xFF), 2, cv2.FONT_HERSHEY_COMPLEX_SMALL)
          if FLAGS.yaxis:
            cv2.putText(frame, f'down: {down} up: {up}', (5, 155), font, 3, (0, 0xFF, 0xFF), 2, cv2.FONT_HERSHEY_COMPLEX_SMALL)
          if count!= None:
